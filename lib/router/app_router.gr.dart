...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    CategoriesDetailesRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: CategoriesDetailesPage(),
      );
    },
...
/// generated route for
/// [CategoriesDetailesPage]
class CategoriesDetailesRoute extends PageRouteInfo<void> {
  const CategoriesDetailesRoute({List<PageRouteInfo>? children})
      : super(
          CategoriesDetailesRoute.name,
          initialChildren: children,
        );

  static const String name = 'CategoriesDetailesRoute';
